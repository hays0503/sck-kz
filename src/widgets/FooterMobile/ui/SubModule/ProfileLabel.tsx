...
export const ProfileLabel: React.FC<ProfileLabelProps> = ({ styleActive, styleActiveBg, styleActiveAccent, text, size }) => {
  const t = useTranslations("ProfileLabel");
  const imageContainerStyle: CSSProperties = {
    width:"100%",
    height:size,
    contain: "strict",
 }
  return <Flex vertical={true} gap={5} align="center">
